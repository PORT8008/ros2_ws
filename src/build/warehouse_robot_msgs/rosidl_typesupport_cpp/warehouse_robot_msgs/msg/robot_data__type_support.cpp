...
static const _RobotData_type_support_symbol_names_t _RobotData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, warehouse_robot_msgs, msg, RobotData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, warehouse_robot_msgs, msg, RobotData)),
  }
};
...
{
  return &::warehouse_robot_msgs::msg::rosidl_typesupport_cpp::RobotData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, warehouse_robot_msgs, msg, RobotData)() {
  return get_message_type_support_handle<warehouse_robot_msgs::msg::RobotData>();
}
