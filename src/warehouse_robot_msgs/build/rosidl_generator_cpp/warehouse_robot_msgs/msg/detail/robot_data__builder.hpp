...
class Init_RobotData_ar_tag_pose
{
public:
  explicit Init_RobotData_ar_tag_pose(::warehouse_robot_msgs::msg::RobotData & msg)
  : msg_(msg)
  {}
  ::warehouse_robot_msgs::msg::RobotData ar_tag_pose(::warehouse_robot_msgs::msg::RobotData::_ar_tag_pose_type arg)
  {
    msg_.ar_tag_pose = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_RobotData_ar_tag_pose status(::warehouse_robot_msgs::msg::RobotData::_status_type arg)
  {
    msg_.status = std::move(arg);
    return Init_RobotData_ar_tag_pose(msg_);
  }
