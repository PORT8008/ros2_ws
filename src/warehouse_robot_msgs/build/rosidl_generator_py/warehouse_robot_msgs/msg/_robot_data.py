...
class RobotData(metaclass=Metaclass_RobotData):
    ...
    _fields_and_field_types = {
        ...
        'status': 'string',
        'ar_tag_pose': 'geometry_msgs/Pose',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Pose
        self.ar_tag_pose = kwargs.get('ar_tag_pose', Pose())
    ...
    def __eq__(self, other):
        ...
        if self.status != other.status:
            return False
        if self.ar_tag_pose != other.ar_tag_pose:
            return False
        return True
    ...
    @builtins.property
    def ar_tag_pose(self):
        """Message field 'ar_tag_pose'."""
        return self._ar_tag_pose

    @ar_tag_pose.setter
    def ar_tag_pose(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'ar_tag_pose' field must be a sub message of type 'Pose'"
        self._ar_tag_pose = value
